...
public class ShortestPathActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        for (GarbageCollector g : list) {
            ...
            mGoogleMap.addMarker(new MarkerOptions().position(pos).title("Marker " + g.getName()).icon(BitmapDescriptorFactory.fromResource(R.drawable.immagine3)));
            //possibilità di aggiungere icona cestino
        }

        LatLng classroom = new LatLng(41.890758, 12.503817);

        mGoogleMap.addMarker(new MarkerOptions().position(classroom).title("Marker in classroom"));
        //mGoogleMap.moveCamera(CameraUpdateFactory.newLatLngZoom(classroom, 18));
